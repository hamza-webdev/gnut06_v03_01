...
# Script de déploiement sécurisé pour gnut06 sur VPS (avec clé SSH)
# Usage: ./deploy-secure.sh
# Prérequis: Configurer une clé SSH avec ssh-copy-id vpsadmin@167.86.93.157
...
echo "🚀 Début du déploiement sécurisé de gnut06..."
